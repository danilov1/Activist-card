...
elseif($_GET['act'] == "studentsupload_connect") {
	...
	// Проверка выборки
	$allRows = array("nodata", "id", "sname", "fname", "pname", "sex", "birthday", "phone", "edu_type", "edu_level", "edu_standard", "department", "group_name", "group_num", "pay");
	$necessoryRows = array("id", "sname", "fname", "pname", "edu_level", "department", "group_name", "group_num");
...
`fac` = '".$depID."',
`dep` =  '".$groupID."',
`curcourse` =  '".$JSONStudentsData[$i][($CONNECTIONS["edu_level"])]."-".substr($JSONStudentsData[$i][($CONNECTIONS["group_num"])], 0, 1)."',
