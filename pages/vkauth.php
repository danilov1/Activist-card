<?php
	...
	$vkauthreq = "UPDATE `".$GLOBALS['config_db']['mysql_db']."`.`users` SET `vktoken` = '".$token['access_token']."' WHERE `users`.`id` =".$vkauth[0].";"; // обновление ключа
	...
	$authreq = "INSERT INTO `".$GLOBALS['config_db']['mysql_db']."`.`tokens` (`token`, `lastip`, `deadline`, `user`) VALUES ('".$newtoken."', '".$vkcurip."', '".$fromunix."', '".$vkauth[0]."')";
